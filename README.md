...
- Выбор одной или нескольких услуг перед записью.
...
- Уведомление клиента, если админ отменил запись.
- Проверка телефона по регулярному выражению (без букв).
...
- Админ-панель:
  ...
  - Просмотр всех записей через меню Месяц → День.
  - Добавление/обновление услуг и цен.
